...
import { useOperationsUseCases } from '@/src/platform/tools/operations/composition/use-operations-use-cases';
import { useBackgroundJobs } from '@/src/platform/tools/operations/presentation/queries/use-operations';
import { formatPlatformDate, getPlatformToolErrorMessage } from '@/src/platform/tools/utils/platform-tool-utils';
import {
  AppButton,
  AppCard,
  AppIcon,
...
export function HangfireDashboardScreen() {
  ...
  const operations = useOperationsUseCases();
  const jobsQuery = useBackgroundJobs();
  const dashboardUrl = operations.getHangfireUrl();
