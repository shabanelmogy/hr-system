...
import { useHealthCheck } from '@/src/platform/tools/operations/presentation/queries/use-operations';
import type {
  HealthCheckEntry,
  HealthStatus,
} from '@/src/platform/tools/operations/domain/models/operations';
