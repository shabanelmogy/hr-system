...
import { LocalizationEditModal } from '@/src/platform/tools/localization/presentation/components/LocalizationEditModal';
import {
  useLocalizationEntries,
  useUpdateLocalization,
} from '@/src/platform/tools/localization/presentation/queries/use-localization';
import type {
  LocalizationCulture,
  LocalizationEntry,
} from '@/src/platform/tools/localization/domain/models/localization';
import { getPlatformToolErrorMessage } from '@/src/platform/tools/utils/platform-tool-utils';
import {
  AppAlert,
  AppDataTable,
