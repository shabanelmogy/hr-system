...
import { AppointmentFormModal } from '@/src/platform/tools/appointments/presentation/components/AppointmentFormModal';
import {
  useAppointments,
  useDeleteAppointment,
  useSaveAppointment,
} from '@/src/platform/tools/appointments/presentation/queries/use-appointments';
import type {
  Appointment,
  AppointmentInput,
  AppointmentRange,
} from '@/src/platform/tools/appointments/domain/models/appointment';
