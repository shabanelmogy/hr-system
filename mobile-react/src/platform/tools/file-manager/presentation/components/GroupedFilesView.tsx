...
import type { StoredFile } from '@/src/platform/tools/file-manager/domain/models/file-manager';
import {
  type FileGroupId,
  getFileIcon,
  groupFiles,
} from '@/src/platform/tools/file-manager/presentation/utils/file-utils';
import { formatPlatformDate } from '@/src/platform/tools/utils/platform-tool-utils';
import {
  AppCard,
