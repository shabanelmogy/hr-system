...
import { useFileManagerUseCases } from '@/src/platform/tools/file-manager/composition/use-file-manager-use-cases';
import { FileActions } from '@/src/platform/tools/file-manager/presentation/components/FileActions';
import { FileViewerModal } from '@/src/platform/tools/file-manager/presentation/components/FileViewerModal';
import { GroupedFilesView } from '@/src/platform/tools/file-manager/presentation/components/GroupedFilesView';
import {
  useDeleteFile,
  useStoredFiles,
  useUploadFiles,
} from '@/src/platform/tools/file-manager/presentation/queries/use-file-manager';
import type { StoredFile, UploadFileAsset } from '@/src/platform/tools/file-manager/domain/models/file-manager';
import {
  classifyFile,
  fileGroupDefinitions,
  type FileGroupId,
  getFileIcon,
} from '@/src/platform/tools/file-manager/presentation/utils/file-utils';
import {
  formatPlatformDate,
  getPlatformToolErrorMessage,
} from '@/src/platform/tools/utils/platform-tool-utils';
import {
  AppDataTable,
...
export function FileManagerScreen() {
  ...
  const fileManager = useFileManagerUseCases();
