...
const breadcrumbsByPath: Record<string, readonly BreadcrumbItem[]> = {
  ...
  [ROUTES.basicData.organizationalStructureManagement]: [
    homeItem,
    basicDataItem,
    { key: 'organizational-structure', labelKey: 'navigation.organizationalStructure', route: ROUTES.basicData.organizationalStructure },
    { key: 'organizational-structure-management', labelKey: 'organizationalStructure.title' },
  ],
  [ROUTES.basicData.organizationalStructureBranches]: [
    homeItem,
    basicDataItem,
    { key: 'organizational-structure', labelKey: 'navigation.organizationalStructure', route: ROUTES.basicData.organizationalStructure },
    { key: 'branches', labelKey: 'organizationalStructure.resources.branches' },
  ],
  [ROUTES.basicData.organizationalStructureDepartments]: [
    homeItem,
    basicDataItem,
    { key: 'organizational-structure', labelKey: 'navigation.organizationalStructure', route: ROUTES.basicData.organizationalStructure },
    { key: 'departments', labelKey: 'organizationalStructure.resources.departments' },
  ],
  [ROUTES.basicData.organizationalStructureDivisions]: [
    homeItem,
    basicDataItem,
    { key: 'organizational-structure', labelKey: 'navigation.organizationalStructure', route: ROUTES.basicData.organizationalStructure },
    { key: 'divisions', labelKey: 'organizationalStructure.resources.divisions' },
  ],
  [ROUTES.basicData.organizationalStructureJobTitles]: [
    homeItem,
    basicDataItem,
    { key: 'organizational-structure', labelKey: 'navigation.organizationalStructure', route: ROUTES.basicData.organizationalStructure },
    { key: 'job-titles', labelKey: 'organizationalStructure.resources.job-titles' },
  ],
  [ROUTES.basicData.organizationalStructureJobLevels]: [
    homeItem,
    basicDataItem,
    { key: 'organizational-structure', labelKey: 'navigation.organizationalStructure', route: ROUTES.basicData.organizationalStructure },
    { key: 'job-levels', labelKey: 'organizationalStructure.resources.job-levels' },
  ],
  [ROUTES.basicData.organizationalStructurePositions]: [
    homeItem,
    basicDataItem,
    { key: 'organizational-structure', labelKey: 'navigation.organizationalStructure', route: ROUTES.basicData.organizationalStructure },
    { key: 'positions', labelKey: 'organizationalStructure.resources.positions' },
  ],
  [ROUTES.basicData.organizationalStructureJobDescriptions]: [
    homeItem,
    basicDataItem,
    { key: 'organizational-structure', labelKey: 'navigation.organizationalStructure', route: ROUTES.basicData.organizationalStructure },
    { key: 'job-descriptions', labelKey: 'organizationalStructure.resources.job-descriptions' },
  ],
  ...
  [ROUTES.administration.offlineOperations]: [
    homeItem,
    administrationItem,
    { key: 'offline-operations', labelKey: 'navigation.offlineOperations' },
  ],
};
