...
export const routePolicies: readonly RoutePolicy[] = [
  ...
  { path: ROUTES.finance.ledgerSetup.accountingSettings, permissions: [permissions.ViewAccountingSetup] },
  { path: ROUTES.finance.ledgerSetup.currencies, permissions: [permissions.ViewAccountingSetup] },
  { path: ROUTES.finance.ledgerSetup.accounts, permissions: [permissions.ViewAccounts] },
  { path: ROUTES.finance.ledgerSetup.hierarchyLevels, permissions: [permissions.ViewAccounts] },
  { path: ROUTES.finance.ledgerSetup.dimensions, permissions: [permissions.ViewDimensions] },
  { path: ROUTES.finance.ledgerSetup.books, permissions: [permissions.ViewAccountingSetup] },
  { path: ROUTES.finance.ledgerSetup.journals, permissions: [permissions.ViewAccountingSetup] },
  { path: ROUTES.finance.ledgerSetup.exchangeRates, permissions: [permissions.ViewAccountingSetup] },
  { path: ROUTES.finance.ledgerSetup.accountDetermination, permissions: [permissions.ViewAccountingSetup] },
  {
