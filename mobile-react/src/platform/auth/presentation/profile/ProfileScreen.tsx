...
} from '@/src/platform/auth/presentation/profile/ProfilePhotoCropModal';
import {
  useProfileInfo,
  useProfilePhoto,
...
} from '@/src/platform/auth/presentation/profile/useProfile';
import type {
  ChangeProfilePasswordFormValues,
  ProfilePhotoUpload,
  UpdateProfileRequest,
} from '@/src/platform/auth/domain/models/profile';
import {
  createChangePasswordSchema,
  createProfileSchema,
} from '@/src/platform/auth/presentation/profile/profile-validation';
import {
  AppAlert,
  AppButton,
  AppCard,
...
export function ProfileScreen() {
  ...
  useEffect(() => {
    if (!isDirty && !passwordForm.formState.isDirty) return;
    return registerUnsavedChange(() => {
      reset(defaults);
      passwordForm.reset();
      setEditing(false);
    });
  }, [defaults, isDirty, passwordForm, passwordForm.formState.isDirty, reset]);
