...
import { PersonalDetailsStep } from '@/src/platform/auth/presentation/register/components/PersonalDetailsStep';
import { ProfilePictureStep } from '@/src/platform/auth/presentation/register/components/ProfilePictureStep';
import { SecurityStep } from '@/src/platform/auth/presentation/register/components/SecurityStep';
import { useRegisterForm } from '@/src/platform/auth/presentation/register/hooks/useRegisterForm';
import {
  AppCard,
  AppForm,
  AppFormStepActions,
