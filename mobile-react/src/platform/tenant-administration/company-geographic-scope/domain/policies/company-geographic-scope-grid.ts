import type { CompanyCountryOption } from '../models/company-geographic-scope';

type CompanyCountryIdInput = string | number;
...
export function normalizeCompanyCountryIds(ids: readonly CompanyCountryIdInput[]) {
