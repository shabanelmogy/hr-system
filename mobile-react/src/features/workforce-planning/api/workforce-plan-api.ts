...
import type { RejectWorkforcePlanAction, UpdateWorkforcePlanRequest, WorkforcePlan, WorkforcePlanAction, WorkforcePlanDetail, WorkforcePlanPageQuery, WorkforcePlanRequest } from '../types/workforce-plan';
...
export const workforcePlanApi = {
  ...
  async getById(id: number): Promise<WorkforcePlanDetail> { return workforcePlanDetailSchema.parse(await apiService.get<unknown>(workforcePlanEndpoints.byId(id))); },
  ...
  async update(id: number, request: UpdateWorkforcePlanRequest): Promise<WorkforcePlanDetail> { return workforcePlanDetailSchema.parse(await apiService.put<unknown, UpdateWorkforcePlanRequest>(workforcePlanEndpoints.byId(id), request)); },
