export const arFiscalYears = {
  fiscalYears: {
    ...
    report: {
      ...
      reportGenerated: 'تم إنشاء تقرير السنوات المالية بنجاح.',
      reportGenerateFailed: 'تعذر إنشاء تقرير السنوات المالية.',
      reportCatalogError: 'تعذر تحميل قائمة تقارير السنوات المالية.',
      reportUnavailable: 'لا يوجد تقرير منشور للسنوات المالية بعد. تواصل مع المسؤول.',
    ...
    messages: { created: 'تم إنشاء السنة المالية.', updated: 'تم تحديث السنة المالية.', archive: 'تمت أرشفة السنة المالية.', restore: 'تمت استعادة السنة المالية.', lifecycle: 'تم نقل حالة السنة المالية.', loadFailed: 'تعذر تحميل السنوات المالية.', saveFailed: 'تعذر حفظ السنة المالية.', actionFailed: 'تعذر تنفيذ إجراء السنة المالية.', conflictReloaded: 'تم تعديل السنة المالية بواسطة عملية أخرى. تم تحميل أحدث نسخة من الخادم؛ راجعها قبل إعادة المحاولة.' },
    confirm: {
