export const arFiscalYears = {
  fiscalYears: {
    ...
    status: { all: 'كل الحالات', draft: 'مسودة', open: 'مفتوحة', closing: 'قيد الإقفال', closed: 'تم الإقفال', locked: 'مقفولة' },
    ...
    lifecycle: { open: 'فتح السنة', beginClosing: 'بدء الإقفال', close: 'إقفال السنة', lock: 'تثبيت الإقفال', reopen: 'إعادة فتح السنة' },
    ...
    confirm: {
      ...
      openTitle: 'فتح السنة المالية؟', openDescription: 'سيصبح التقويم متاحًا لخطط القوى العاملة ولن يمكن تعديله.', beginClosingTitle: 'بدء إقفال السنة المالية؟', beginClosingDescription: 'ستدخل السنة مرحلة الإقفال المحكومة.', closeTitle: 'إقفال السنة المالية؟', closeDescription: 'سيتم إقفال جميع الفترات.', lockTitle: 'تثبيت إقفال السنة المالية؟', lockDescription: 'سيتم قفل السنة وكل فتراتها لمنع التغييرات التشغيلية، ويمكن للمستخدم المخول إعادة فتحها لاحقًا.', reopenTitle: 'إعادة فتح السنة المالية؟', reopenDescription: 'سيتم إعادة فتح السنة سواء كانت في حالة تم الإقفال أو مقفولة، وستعود كل فتراتها إلى الحالة المفتوحة مع الاحتفاظ بسجل التدقيق.',
    },
  },
