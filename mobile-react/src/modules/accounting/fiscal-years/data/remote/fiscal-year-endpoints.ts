export const fiscalYearEndpoints = {
  ...
  beginClosing: (id: number) => `fiscal-years/${id}/begin-closing`, close: (id: number) => `fiscal-years/${id}/close`, lock: (id: number) => `fiscal-years/${id}/lock`, reopen: (id: number) => `fiscal-years/${id}/reopen`,
} as const;
