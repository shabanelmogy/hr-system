...
import type { State, StateDetail, StateLookup, StatePage, StateWithDistricts } from '../../domain/models/state';
...
export const statePageSchema: z.ZodType<StatePage> = z.object({ items: z.array(stateSchema), metaData: pageMetadataSchema });
