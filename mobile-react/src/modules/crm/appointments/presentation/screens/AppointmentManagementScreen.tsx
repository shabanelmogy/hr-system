...
import { AppointmentFormModal } from '@/src/modules/crm/appointments/presentation/components/AppointmentFormModal';
import {
  useAppointments,
  useDeleteAppointment,
  useSaveAppointment,
} from '@/src/modules/crm/appointments/presentation/queries/use-appointments';
import type {
  Appointment,
  AppointmentInput,
  AppointmentRange,
} from '@/src/modules/crm/appointments/domain/models/appointment';
import { getPlatformToolErrorMessage } from '@/src/platform/tools';
...
export function AppointmentManagementScreen() {
  ...
  const openNewAppointment = useCallback((date = new Date(), allDay = false) => {
    if (!appointmentPermissions.canCreate) return;
  ...
  }, [appointmentPermissions.canCreate, t]);
    ...
    <AppScreen
        ...
        action={(
          <View style={styles.headerActions}>
            ...
            <AppIconButton
              ...
              disabled={!appointmentPermissions.canCreate}
              icon="add-outline"
      ...
      {formState ? (
        <AppointmentFormModal
          ...
          readOnly={!appointmentPermissions.canEdit}
          onClose={() => setFormState(null)}
          onDelete={formState.appointment && appointmentPermissions.canDelete ? () => {
