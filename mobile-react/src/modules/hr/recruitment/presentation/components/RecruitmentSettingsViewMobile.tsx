...
} from '../../domain/policies/recruitment-default-settings';
...
export function RecruitmentSettingsViewMobile() {
  ...
  const settingsQuery = useRecruitmentSettings();
  const updateSettingsMutation = useUpdateRecruitmentSettings();

  if (settingsQuery.isLoading) {
    return <AppStateView state="loading" />;
  }
  ...
  const reasons = settings.rejectionReasons;
