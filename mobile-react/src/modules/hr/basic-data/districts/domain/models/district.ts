...
export interface DistrictPageMetadata {
  currentPage: number; totalPages: number; pageSize: number; pageNumber: number; totalCount: number; hasPrev: boolean; hasNext: boolean;
}
export interface DistrictPage { items: District[]; metaData: DistrictPageMetadata; }
