...
export interface OrganizationalStructurePageMetadata {
  currentPage: number;
  totalPages: number;
  pageSize: number;
  pageNumber: number;
...
export interface OrganizationalStructurePage {
  items: OrganizationalStructureItem[];
  metaData: OrganizationalStructurePageMetadata;
}

export interface BulkCreateOrganizationalItemsResponse {
  createdCount: number;
}

export interface ApproveJobDescriptionRequest {
