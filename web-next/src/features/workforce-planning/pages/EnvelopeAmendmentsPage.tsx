...
export default function EnvelopeAmendmentsPage() {
  ...
  const select = (item: EnvelopeAmendmentListItem, next: Dialog) => { setSelected(item); setReason(""); setDialog(next); };
  ...
  const actions = (item: EnvelopeAmendmentListItem): CardActionItem[] => {
