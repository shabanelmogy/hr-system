export const countries = [
  ...
  { ar: "أنغولا", en: "Angola" },
  { ar: "أنتيغوا وباربودا", en: "Antigua and Barbuda" },
  ...
  { ar: "جمهورية إفريقيا الوسطى", en: "Central African Republic" },
  { ar: "تشاد", en: "Chad" },
  { ar: "تشيلي", en: "Chile" },
  { ar: "الصين", en: "China" },
  ...
  { ar: "سانت فنسنت والغرينادين", en: "Saint Vincent and the Grenadines" },
  { ar: "ساموا", en: "Samoa" },
  { ar: "سان مارينو", en: "San Marino" },
  { ar: "ساو تومي وبرينسيب", en: "Sao Tome and Principe" },
  { ar: "السعودية", en: "Saudi Arabia" },
  { ar: "السنغال", en: "Senegal" },
  { ar: "صربيا", en: "Serbia" },
  { ar: "سيشيل", en: "Seychelles" },
