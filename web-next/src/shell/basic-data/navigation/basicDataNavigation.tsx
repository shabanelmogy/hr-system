...
const geographicDataItems: readonly BasicDataNavigationItem[] = [
  { id: "address-types", titleKey: "menu.addressTypes", descriptionKey: "menu.addressTypesDescription", href: appRoutes.modules.referenceData.addressTypes, icon: <CategoryIcon fontSize="small" />, permissions: [permissions.ViewAddressTypes] },
];
...
const organizationalStructureItems: readonly BasicDataNavigationItem[] = [
  {
    ...
    href: appRoutes.modules.hr.organizationalStructure.branches,
  ...
  },
  {
    ...
    href: appRoutes.modules.hr.organizationalStructure.departments,
    icon: <BusinessRoundedIcon fontSize="small" />,
    permissions: [permissions.ViewOrganizationalStructure],
  },
  {
    ...
    href: appRoutes.modules.hr.organizationalStructure.divisions,
    icon: <BusinessRoundedIcon fontSize="small" />,
    permissions: [permissions.ViewOrganizationalStructure],
  },
  {
    ...
    href: appRoutes.modules.hr.organizationalStructure.jobTitles,
    icon: <BusinessRoundedIcon fontSize="small" />,
    permissions: [permissions.ViewOrganizationalStructure],
  },
  {
    ...
    href: appRoutes.modules.hr.organizationalStructure.jobLevels,
    icon: <BusinessRoundedIcon fontSize="small" />,
    permissions: [permissions.ViewOrganizationalStructure],
  },
  {
    ...
    href: appRoutes.modules.hr.organizationalStructure.positions,
    icon: <BusinessRoundedIcon fontSize="small" />,
    permissions: [permissions.ViewOrganizationalStructure],
  },
  {
    ...
    href: appRoutes.modules.hr.organizationalStructure.jobDescriptions,
    icon: <BusinessRoundedIcon fontSize="small" />,
    permissions: [permissions.ViewOrganizationalStructure],
  },
  {
  ...
  },
  {
    ...
    href: appRoutes.platform.companyGeographicScope,
