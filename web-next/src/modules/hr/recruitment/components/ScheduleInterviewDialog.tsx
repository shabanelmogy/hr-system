...
import { scheduleInterviewSchema, type ScheduleInterviewFormData, type ScheduleInterviewFormInput } from "../validation/recruitmentValidation";
...
export default function ScheduleInterviewDialog({
  ...
  const {
    ...
    reset,
    formState: { errors },
  } = useForm<ScheduleInterviewFormInput, unknown, ScheduleInterviewFormData>({
  ...
  const onSubmit = async (data: ScheduleInterviewFormData) => {
    ...
    try {
      await scheduleMutation.mutateAsync({
        ...
        leadEmployeeId: data.leadEmployeeId || undefined,
      });
