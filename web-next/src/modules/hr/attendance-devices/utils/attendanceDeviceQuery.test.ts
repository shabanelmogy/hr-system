...
describe("attendance device query mapping", () => {
  it("converts the zero-based UI page and omits blank search", () => expect(toAttendanceDeviceQuery({ page: 0, pageSize: 10 }, "  ")).toEqual({ pageNumber: 1, pageSize: 10, search: undefined }));
