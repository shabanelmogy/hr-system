...
const fiscalYearName = (t: TFunction) => z.string()
  .trim()
  .min(1, t("fiscalYears.validation.name"))
  .max(100, t("fiscalYears.validation.name"))
  .refine(value => !/[\u0000-\u001F\u007F]/u.test(value), t("fiscalYears.validation.name"));
...
export const getFiscalYearSchema = (t: TFunction) => z.object({
  ...
  nameAr: fiscalYearName(t),
  nameEn: fiscalYearName(t),
