...
const ledgerSetupNavigation = createNavSection(
  ...
  [
    ...
    createNavItem("menu.accountingSettings", createColoredIcon(<SettingsRoundedIcon />, "#059669"), appRoutes.modules.accounting.ledgerSetup.accountingSettings, undefined, [permissions.ViewAccountingSettings]),
    createNavItem(
      "menu.currencies",
    ...
    createNavItem("menu.hierarchyLevels", createColoredIcon(<SchemaRoundedIcon />, "#2563eb"), appRoutes.modules.accounting.ledgerSetup.hierarchyLevels, undefined, [permissions.ViewAccountHierarchyLevels]),
    createNavItem("menu.dimensions", createColoredIcon(<SchemaRoundedIcon />, "#7c3aed"), appRoutes.modules.accounting.ledgerSetup.dimensions, undefined, [permissions.ViewDimensionDefinitions]),
    createNavItem("menu.books", createColoredIcon(<MenuBookRoundedIcon />, "#be123c"), appRoutes.modules.accounting.ledgerSetup.books, undefined, [permissions.ViewBooks]),
    createNavItem("menu.journals", createColoredIcon(<MenuBookRoundedIcon />, "#e11d48"), appRoutes.modules.accounting.ledgerSetup.journals, undefined, [permissions.ViewJournalDefinitions]),
    createNavItem("menu.exchangeRates", createColoredIcon(<CurrencyExchangeRoundedIcon />, "#0891b2"), appRoutes.modules.accounting.ledgerSetup.exchangeRates, undefined, [permissions.ViewExchangeRateTypes]),
    createNavItem("menu.accountDetermination", createColoredIcon(<RuleRoundedIcon />, "#d97706"), appRoutes.modules.accounting.ledgerSetup.accountDetermination, undefined, [permissions.ViewAccountMappings]),
  ],
  undefined,
  undefined,
);
