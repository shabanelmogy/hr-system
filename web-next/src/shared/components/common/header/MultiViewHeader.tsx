...
interface MultiViewHeaderProps {
  ...
  additionalChips?: React.ComponentProps<typeof Chip>[];
  sx?: React.ComponentProps<typeof Paper>["sx"];
  onViewTypeChange?: (viewType: ViewType) => void;
  viewComponents?: Record<string, React.ComponentType>;
...
const MultiViewHeader = ({
  ...
  const getViewIcon = (view: ViewType) => {
    ...
    return iconMap[view as keyof typeof iconMap] || <ViewModule />;
  };
  ...
  const getViewLabel = (view: ViewType) => {
    ...
    return (
      viewLabels[view] ||
      t(`views.${view}`) ||
      defaultLabels[view as keyof typeof defaultLabels] ||
      view
    );
  };
  ...
  const handleViewChangeInternal = (
    event: React.MouseEvent<HTMLElement> | null,
    newLayout: ViewType | null
  ) => {
