...
{
    private readonly ICountryValidationQueries _queries;
    private readonly IStringLocalizer<CountryRequest> _localizer;

    public CountryRequestValidator(ICountryValidationQueries queries, IStringLocalizer<CountryRequest> localizer)
    {
        _queries = queries;
    ...
    private async Task<bool> IsCountryNameEnUniqueAsync(CountryRequest country, CancellationToken cancellationToken)
    {
        ...
        return !await _queries.CountryNameEnExistsAsync(nameEn, countryId, cancellationToken);
    }
    ...
    private async Task<bool> IsCountryNameArUniqueAsync(CountryRequest country, CancellationToken cancellationToken)
    {
        ...
        return !await _queries.CountryNameArExistsAsync(nameAr, countryId, cancellationToken);
    }
    ...
    private async Task<bool> IsAlpha2CodeUniqueAsync(CountryRequest country, CancellationToken cancellationToken)
    {
        ...
        return !await _queries.CountryAlpha2CodeExistsAsync(alpha2Code, countryId, cancellationToken);
    }
    ...
    private async Task<bool> IsAlpha3CodeUniqueAsync(CountryRequest country, CancellationToken cancellationToken)
    {
        ...
        return !await _queries.CountryAlpha3CodeExistsAsync(alpha3Code, countryId, cancellationToken);
    }
}
