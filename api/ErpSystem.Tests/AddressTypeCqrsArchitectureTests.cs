...
using ErpSystem.Modules.HR.Presentation.Features.GeographicalInformation.AddressTypes.V1;
...
using ErpSystem.Modules.HR.Application.Features.GeographicalInformation.AddressTypes.Commands;
using ErpSystem.Modules.HR.Application.Features.GeographicalInformation.AddressTypes.Contracts;
using ErpSystem.Modules.HR.Application.Features.GeographicalInformation.AddressTypes.Mapping;
using ErpSystem.Modules.HR.Application.Features.GeographicalInformation.AddressTypes.Queries;
...
public sealed class AddressTypeCqrsArchitectureTests
{
    ...
    public void MappingConfiguration_NormalizesOnlyMutableAddressTypeFields()
    {
        ...
        var addressType = new CreateAddressTypeCommand("  سكن  ", "  Residence  ")
            .Adapt<ErpSystem.Modules.HR.Domain.GeographicalInformation.AddressTypes.Entities.AddressType>(config);
