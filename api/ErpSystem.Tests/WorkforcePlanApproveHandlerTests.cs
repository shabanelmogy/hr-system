...
public sealed class WorkforcePlanApproveHandlerTests
{
    ...
    public async Task Approve_AllowsAdminToApproveOwnPlan()
    {
        ...
        var harness = CreateHarness(plan, new RoleActor("creator", AppRoles.admin));
    ...
    [Fact]
    public void CurrentActor_IsInRole_ReflectsRoleClaims()
    {
        ...
        Assert.True(actor.IsInRole(AppRoles.admin));
        Assert.False(actor.IsInRole(AppRoles.user));
    }
