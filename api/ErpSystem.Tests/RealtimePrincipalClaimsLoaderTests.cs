...
public sealed class RealtimePrincipalClaimsLoaderTests
{
    ...
    public async Task LoadAsync_ReplacesTokenAuthorizationClaimsWithCurrentTenantDatabaseClaims()
    {
        ...
        [
            ...
            new Claim(AuthenticationTokenClaimNames.TenantRoleId, "stale-role-id"),
        ...
        Assert.Equal(
            [tenantRole.Id],
            principal.FindAll(AuthenticationTokenClaimNames.TenantRoleId).Select(claim => claim.Value));
    }
