...
public sealed class PlatformTenantReadOnlyMiddlewareOwnershipTests
{
    ...
    public void Ownership_MovesMiddlewareAndMetadataToPlatformWithoutPlatformReferencingHr()
    {
        ...
        Assert.Null(typeof(ErpSystem.Modules.HR.Presentation.AssemblyReference).Assembly.GetType(
            "ErpSystem.Modules.HR.Presentation.Common.Tenancy.TenantReadOnlyMiddleware"));
        Assert.Null(typeof(ErpSystem.Modules.HR.Presentation.AssemblyReference).Assembly.GetType(
            "ErpSystem.Modules.HR.Presentation.Common.Tenancy.AllowTenantReadOnlyAttribute"));
