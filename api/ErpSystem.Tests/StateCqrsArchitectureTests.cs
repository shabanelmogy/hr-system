...
using ErpSystem.Modules.HR.Presentation.Features.GeographicalInformation.States.V1;
...
public sealed class StateCqrsArchitectureTests
{
    ...
    public void MappingConfiguration_NormalizesOnlyMutableStateFields()
    {
        ...
        var state = new CreateStateCommand("  القاهرة  ", "  Cairo  ", " cai ", 7)
            .Adapt<ErpSystem.Modules.HR.Domain.GeographicalInformation.States.Entities.State>(config);
