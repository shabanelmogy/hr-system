...
using ErpSystem.Modules.HR.Application.Features.GeographicalInformation;
...
using ErpSystem.Modules.HR.Application.Features.GeographicalInformation.Districts.Commands;
...
using ErpSystem.Modules.HR.Application.Features.GeographicalInformation.Districts.Mapping;
using ErpSystem.Modules.HR.Application.Features.GeographicalInformation.Districts.Queries;
using ErpSystem.Modules.HR.Application.Features.GeographicalInformation.States.Abstractions;
using ErpSystem.Modules.HR.Application.Features.GeographicalInformation.States.Commands;
...
using ErpSystem.Modules.HR.Application.Features.GeographicalInformation.States.Mapping;
