...
using ErpSystem.Modules.HR.Presentation.Features.GeographicalInformation.Districts.V1;
...
public sealed class DistrictCqrsArchitectureTests
{
    ...
    public void MappingConfiguration_NormalizesOnlyMutableDistrictFields()
    {
        ...
        var district = new CreateDistrictCommand("  القاهرة  ", "  Cairo  ", " cai ", 7)
            .Adapt<ErpSystem.Modules.HR.Domain.GeographicalInformation.Districts.Entities.District>(config);
