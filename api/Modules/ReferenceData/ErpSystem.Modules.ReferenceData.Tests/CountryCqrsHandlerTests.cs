...
using ErpSystem.Modules.ReferenceData.Application.Features.GeographicalInformation;
using ErpSystem.Modules.ReferenceData.Application.Features.GeographicalInformation.Countries.Abstractions;
using ErpSystem.Modules.ReferenceData.Application.Features.GeographicalInformation.Countries.Commands.ArchiveCountry;
using ErpSystem.Modules.ReferenceData.Application.Features.GeographicalInformation.Countries.Commands.BulkArchiveCountries;
using ErpSystem.Modules.ReferenceData.Application.Features.GeographicalInformation.Countries.Commands.CreateCountry;
using ErpSystem.Modules.ReferenceData.Application.Features.GeographicalInformation.Countries.Commands.CreateCountries;
using ErpSystem.Modules.ReferenceData.Application.Features.GeographicalInformation.Countries.Commands.RestoreCountry;
using ErpSystem.Modules.ReferenceData.Application.Features.GeographicalInformation.Countries.Commands.UpdateCountry;
...
using ErpSystem.Modules.ReferenceData.Application.Features.GeographicalInformation.Countries.Mapping;
using ErpSystem.Modules.ReferenceData.Application.Features.GeographicalInformation.Countries.Queries.GetCountries;
using ErpSystem.Modules.ReferenceData.Application.Features.GeographicalInformation.Countries.Queries.GetCountryById;
using ErpSystem.Modules.ReferenceData.Application.Features.GeographicalInformation.Countries.Queries.GetCountryWithStates;
...
public sealed class CountryCqrsHandlerTests
{
    ...
    public async Task BulkCreate_UsesRegularUnitOfWorkAuditing()
    {
        ...
        var handler = new CreateCountriesCommandHandler(
            CreateWriteStore(context), context, scheduler, new TestCurrentActor(), CreateErrors(), CreateMapper());
    ...
    private static ReferenceDataDbContext CreateContext()
    {
        var options = new DbContextOptionsBuilder<ReferenceDataDbContext>()
            ...
            .Options;
        return new ReferenceDataDbContext(options, new TestCurrentActor());
    }

    private static CountryWriteStore CreateWriteStore(ReferenceDataDbContext context) =>
        new(context, new NoCompanyGeographyUsage());
    ...
    private sealed class RecordingAuditTrail : ICountryAuditTrail
    {
        ...
        public Task RecordUpdateAsync(Country existingCountry, Country updatedCountry, CancellationToken cancellationToken) { Called = true; return Task.CompletedTask; }
    }
    ...
    private sealed class NoCompanyGeographyUsage : ICompanyGeographySource
    {
        public Task<bool> HasCompanyUsageAsync(
            IReadOnlyCollection<int> countryIds,
