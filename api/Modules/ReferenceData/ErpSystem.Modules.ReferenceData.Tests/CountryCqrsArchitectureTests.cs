using ErpSystem.Modules.ReferenceData.Presentation.Features.GeographicalInformation.Countries.V1;
...
using ErpSystem.Modules.ReferenceData.Application.Features.GeographicalInformation.Countries.Queries.GetCountryLookup;
...
using ErpSystem.Modules.ReferenceData.Application.Features.GeographicalInformation.Countries.Queries.GetCountryReportData;
...
public sealed class CountryCqrsArchitectureTests
{
    ...
    public void LegacyCountryServiceAndToggleTypes_AreRemoved()
    {
        ...
        Assert.Null(application.GetType(
            "ErpSystem.Modules.ReferenceData.Application.Features.GeographicalInformation.Countries.Services.ICountryService"));
        Assert.Null(infrastructure.GetType(
            "ErpSystem.Modules.ReferenceData.Infrastructure.Features.GeographicalInformation.Countries.Services.CountryService"));
        Assert.DoesNotContain(
