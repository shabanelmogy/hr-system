...
using ErpSystem.Modules.ReferenceData.Application.Features.GeographicalInformation.Districts.Commands;
...
using ErpSystem.Modules.ReferenceData.Application.Features.GeographicalInformation.Districts.Mapping;
...
using ErpSystem.Modules.ReferenceData.Application.Features.GeographicalInformation.States.Commands;
...
using ErpSystem.Modules.ReferenceData.Application.Features.GeographicalInformation.States.Mapping;
...
public sealed class GeographicParentReassignmentHandlerTests
{
    ...
    {
        public Task RecordUpdateAsync(State existingState, State updatedState, CancellationToken cancellationToken) => Task.CompletedTask;
    }

    private sealed class RecordingDistrictAuditTrail : IDistrictAuditTrail
    {
        public Task RecordUpdateAsync(District existingDistrict, District updatedDistrict, CancellationToken cancellationToken) => Task.CompletedTask;
    }
