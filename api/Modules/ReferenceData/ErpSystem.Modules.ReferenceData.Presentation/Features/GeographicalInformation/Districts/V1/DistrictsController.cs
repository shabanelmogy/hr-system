...
namespace ErpSystem.Modules.ReferenceData.Presentation.Features.GeographicalInformation.Districts.V1;
...
{
    [HttpGet]
    [HasPermission(ReferenceDataPermissions.ViewDistricts)]
    ...
    [HttpPost]
    [HasPermission(ReferenceDataPermissions.CreateDistricts)]
    ...
    [HttpPut("{id:int}")]
    [HasPermission(ReferenceDataPermissions.EditDistricts)]
    [ProducesResponseType(typeof(DistrictDetailResponse), StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status400BadRequest)]
    [ProducesResponseType(StatusCodes.Status404NotFound)]
    [ProducesResponseType(StatusCodes.Status409Conflict)]
