...
namespace ErpSystem.Modules.ReferenceData.Presentation.Features.GeographicalInformation.States.V1;
...
public sealed class StatesController(ISender sender) : ControllerBase
{
    ...
    [HttpGet]
    [HasPermission(ReferenceDataPermissions.ViewStates)]
    ...
    [HttpPost]
    [HasPermission(ReferenceDataPermissions.CreateStates)]
    ...
    [HttpPut("{id:int}")]
    [HasPermission(ReferenceDataPermissions.EditStates)]
    [ProducesResponseType(typeof(StateDetailResponse), StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status400BadRequest)]
    [ProducesResponseType(StatusCodes.Status404NotFound)]
    [ProducesResponseType(StatusCodes.Status409Conflict)]
