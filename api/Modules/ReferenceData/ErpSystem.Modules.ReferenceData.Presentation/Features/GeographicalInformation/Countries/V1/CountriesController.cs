...
namespace ErpSystem.Modules.ReferenceData.Presentation.Features.GeographicalInformation.Countries.V1;
...
public sealed class CountriesController(ISender sender) : ControllerBase
{
    ...
    [HttpGet]
    [HasPermission(ReferenceDataPermissions.ViewCountries)]
    ...
    [HttpPost]
    [HasPermission(ReferenceDataPermissions.CreateCountries)]
    ...
    [HttpPut("{id:int}")]
    [HasPermission(ReferenceDataPermissions.EditCountries)]
    [ProducesResponseType(typeof(CountryDetailResponse), StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status400BadRequest)]
    [ProducesResponseType(StatusCodes.Status404NotFound)]
    [ProducesResponseType(StatusCodes.Status409Conflict)]
