...
namespace ErpSystem.Modules.ReferenceData.Application.Features.GeographicalInformation.Addresses.Errors;
...
public class AddressErrors(IStringLocalizer<AddressRequest> localizer)
{
    ...
    public Error AddressTypeNotFound =>
            new("Address.InvalidAddressType", _localizer[ValidationMessageKeys.InvalidAddressType], ErrorType.Validation);

    public Error InvalidCountry =>
            new("Address.InvalidCountry", _localizer[ValidationMessageKeys.InvalidCountry], ErrorType.Validation);

    public Error InvalidState =>
            new("Address.InvalidState", _localizer[ValidationMessageKeys.InvalidState], ErrorType.Validation);

    public Error InvalidDistrict =>
            new("Address.InvalidDistrict", _localizer[ValidationMessageKeys.InvalidDistrict], ErrorType.Validation);
