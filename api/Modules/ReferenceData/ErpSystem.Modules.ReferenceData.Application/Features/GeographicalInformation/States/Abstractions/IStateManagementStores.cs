...
namespace ErpSystem.Modules.ReferenceData.Application.Features.GeographicalInformation.States.Abstractions;
...
{
    Task RecordUpdateAsync(State existingState, State updatedState, CancellationToken cancellationToken);
}
