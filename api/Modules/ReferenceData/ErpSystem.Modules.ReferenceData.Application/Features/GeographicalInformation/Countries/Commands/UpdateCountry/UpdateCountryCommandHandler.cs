...
namespace ErpSystem.Modules.ReferenceData.Application.Features.GeographicalInformation.Countries.Commands.UpdateCountry;
    ...
    : ICommandHandler<UpdateCountryCommand, Result<CountryDetailResponse>>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        await countryAuditTrail.RecordUpdateAsync(country, updatedCountry, cancellationToken);
