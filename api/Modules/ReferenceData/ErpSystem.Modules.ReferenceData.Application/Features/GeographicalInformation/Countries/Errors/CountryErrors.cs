...
namespace ErpSystem.Modules.ReferenceData.Application.Features.GeographicalInformation.Countries.Errors;
...
public class CountryErrors(IStringLocalizer<CreateCountryRequest> localizer)
{
    ...
    public Error CountryInUseByCompany =>
            new("Country.CountryInUseByCompany", _localizer[nameof(CountryInUseByCompany)], ErrorType.Validation);
