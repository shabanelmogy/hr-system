...
public sealed class AccountsController(ISender sender) : ControllerBase
{
    ...
    [HttpGet("hierarchy-levels")] [HasPermission(AccountingPermissions.ViewAccountHierarchyLevels)] public Task<IReadOnlyList<AccountHierarchyLevelResponse>> Levels([FromQuery] GetAccountHierarchyLevelsQuery query, CancellationToken cancellationToken) => sender.Send(query, cancellationToken);
