...
using ErpSystem.Modules.Accounting.Application.Features.Finance.FiscalYears.Queries;
using ErpSystem.Modules.Accounting.Application.Features.Finance.FiscalYears.Queries.GetFiscalYears;
using MediatR;

namespace ErpSystem.Modules.Accounting.Presentation.Features.Finance.FiscalYears.V1;
...
public sealed class FiscalYearsController(ISender sender) : ControllerBase
{
    ...
    [HttpPost]
    [HasPermission(AccountingPermissions.CreateFiscalYears)]
    ...
    [HttpPut("{id:int}")]
    [HasPermission(AccountingPermissions.EditFiscalYears)]
    [ProducesResponseType(typeof(FiscalYearDetailResponse), StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status404NotFound)]
    [ProducesResponseType(StatusCodes.Status409Conflict)]
