...
internal sealed class OutboxMessageConfiguration : IEntityTypeConfiguration<OutboxMessage>
{
    public void Configure(EntityTypeBuilder<OutboxMessage> builder)
    {
        ...
        builder.Property(message => message.ContentType).HasMaxLength(128).IsRequired();
        ...
        builder.HasIndex(message => new { message.Status, message.NextAttemptOnUtc, message.OccurredOnUtc });
    }
}
