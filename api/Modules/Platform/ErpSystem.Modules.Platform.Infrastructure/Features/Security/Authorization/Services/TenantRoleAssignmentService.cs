...
public sealed class TenantRoleAssignmentService(PlatformDbContext context)
{
    private static readonly string AdminName = PlatformRoleNames.Admin.ToUpperInvariant();
    private static readonly string UserName = PlatformRoleNames.User.ToUpperInvariant();
    private static readonly string SuperAdminName = PlatformRoleNames.SuperAdmin.ToUpperInvariant();

    public async Task<IReadOnlyList<PlatformApplicationRole>?> ResolveAssignableRolesAsync(
        string tenantId,
    ...
    public void AddAssignments(string userId, IEnumerable<PlatformApplicationRole> roles)
    {
    ...
    public async Task SynchronizeAssignmentsAsync(
        string userId,
        string tenantId,
        IReadOnlyCollection<PlatformApplicationRole> requestedRoles,
        CancellationToken cancellationToken = default)
    {
