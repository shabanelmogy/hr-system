...
namespace ErpSystem.Modules.Platform.Infrastructure.Features.Platform.Files.Persistence;

public sealed class PlatformFileOperationsStore(
...
{
    private readonly string _filesPath = PlatformFileStoragePaths.GetUploadsPath(environment);
    private readonly string _imagesPath = PlatformFileStoragePaths.GetImagesPath(environment);
