...
/// <summary>
/// Platform persistence/query adapter over the module-owned EntityChangeLog
/// table and Identity user store. Change detection and response shaping are
/// owned by Platform.Application.
/// </summary>
public sealed class EntityChangeLogPersistenceAdapter(PlatformDbContext context)
