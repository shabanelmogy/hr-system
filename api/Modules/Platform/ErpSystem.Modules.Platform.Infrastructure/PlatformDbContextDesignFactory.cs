...
/// <summary>
/// Creates only the Platform context for EF design-time commands without
/// booting the API host or any other module.
/// </summary>
public sealed class PlatformDbContextDesignFactory
    : IDesignTimeDbContextFactory<PlatformDbContext>
{
    ...
    private static string ResolveConnectionString()
    {
        ...
        foreach (var name in new[] { "Platform", "DefaultConnection" })
        {
        ...
        throw new InvalidOperationException(
            "No effective connection string was configured. Set ConnectionStrings:Platform "
            + "or ConnectionStrings:DefaultConnection before running Platform EF design-time commands.");
    }
