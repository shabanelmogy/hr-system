...
public sealed class SignalRRealtimeEntityPublisher(
    ...
    IModuleCatalogPolicy moduleCatalog) : IRealtimeEntityPublisher
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var group = ResolveGroup(request.Audience, moduleCatalog.GetKnownPermissions());
    ...
    internal static string ResolveGroup(
        ...
        IReadOnlySet<string> knownPermissions)
    {
        ...
        return audience.Kind switch
        {
            RealtimeAudienceKind.Permission =>
                GeneralHubGroups.ForPermission(KnownPermission(audience.Permission, knownPermissions)),
            RealtimeAudienceKind.TenantPermission =>
                GeneralHubGroups.ForTenantPermission(
                    ...
                    KnownPermission(audience.Permission, knownPermissions)),
    ...
    private static string KnownPermission(string? permission, IReadOnlySet<string> knownPermissions)
    {
