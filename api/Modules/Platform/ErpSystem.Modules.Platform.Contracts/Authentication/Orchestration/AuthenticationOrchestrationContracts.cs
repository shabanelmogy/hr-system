namespace ErpSystem.Modules.Platform.Contracts.Authentication.Orchestration;
...
/// <summary>Platform-owned application seam consumed by presentation compatibility facades.</summary>
public interface IAuthenticationLoginOrchestrator : IAuthenticationLoginFlow;
...
public interface IAuthenticationSessionOrchestrator : IAuthenticationSessionFlow;
...
public interface IAuthenticationSessionContextService
{
    Task<AuthenticationSessionContextResponse?> GetAsync(
...
public interface IAuthenticationAccountOrchestrator : IAuthenticationAccountFlow;
