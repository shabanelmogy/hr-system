...
namespace ErpSystem.Modules.Platform.Contracts.Tenancy.Administration;
...
public interface ITenantManagementOrchestrator : ITenantManagementFlow;

/// <summary>
/// Port implemented by the legacy module that still owns the physical tenant tables.
/// </summary>
...
public interface ITenantAdministratorOrchestrator : ITenantAdministratorFlow;

/// <summary>
/// Port implemented by the legacy ASP.NET Identity/HR storage edge.
/// </summary>
public interface ITenantAdministratorAdapter : ITenantAdministratorFlow;

/// <summary>
/// Reusable tenancy administration rules owned by Platform while legacy HR storage
/// remains responsible for EF/Identity transactions and physical table mappings.
/// </summary>
