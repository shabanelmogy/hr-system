...
public sealed class RefreshTokenSessionPolicyTests
{
    ...
    public void RevokeAll_RevokesOnlyActiveTokens()
    {
        ...
        var tokens = new List<PlatformRefreshToken> { active, alreadyRevoked, expired };
    ...
    public void RevokeSession_RevokesOnlyTheReplacedActiveSession()
    {
        ...
        var tokens = new List<PlatformRefreshToken> { replaced, retained };
    ...
    public void Prune_RemovesStaleInactiveTokensAndKeepsActiveTokens()
    {
        ...
        var active = CreateToken("active", Now.AddMinutes(-5), Now.AddDays(1));
        var tokens = new List<PlatformRefreshToken> { stale, recent, active };
    ...
    private static PlatformRefreshToken CreateToken(
        string tokenHash,
        DateTime createdOn,
        DateTime expiresOn) =>
