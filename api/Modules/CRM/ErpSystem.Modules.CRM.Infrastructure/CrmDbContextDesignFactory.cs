...
/// <summary>
/// Creates only the CRM context for EF design-time commands without
/// booting the API host or any other module.
/// </summary>
public sealed class CrmDbContextDesignFactory
    : IDesignTimeDbContextFactory<CrmDbContext>
{
    ...
    private static string ResolveConnectionString()
    {
        var environment = Environment.GetEnvironmentVariable("DOTNET_ENVIRONMENT")
            ...
            ?? "Development";
        // AddEnvironmentVariables below loads ConnectionStrings__CRM
        ...
        foreach (var name in new[] { "CRM", "DefaultConnection" })
        {
        ...
        throw new InvalidOperationException(
            "No effective connection string was configured. Set ConnectionStrings:CRM "
            + "or ConnectionStrings:DefaultConnection before running CRM EF design-time commands.");
    }
