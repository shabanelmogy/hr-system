...
using ErpSystem.Modules.Reporting.Application.Features.Analytics.ReportTemplates.Commands.DuplicateReportTemplate;
using ErpSystem.Modules.Reporting.Application.Features.Analytics.ReportTemplates.Commands.UpdateReportTemplate;
using ErpSystem.Modules.Reporting.Application.Features.Analytics.ReportTemplates.Contracts;
using ErpSystem.Modules.Reporting.Application.Features.Analytics.ReportTemplates.Queries.GetReportDataSources;
using ErpSystem.Modules.Reporting.Application.Features.Analytics.ReportTemplates.Queries.GetReportTemplateById;
using ErpSystem.Modules.Reporting.Application.Features.Analytics.ReportTemplates.Queries.GetReportTemplateRevisions;
using ErpSystem.Modules.Reporting.Application.Features.Analytics.ReportTemplates.Queries.GetReportTemplates;
using MediatR;

namespace ErpSystem.Modules.Reporting.Presentation.Features.Analytics.ReportTemplates.V1;
...
public sealed class ReportTemplatesController(ISender sender) : ControllerBase
{
    ...
    [HttpGet]
    [HasPermission(ReportingPermissions.ViewReportTemplates)]
    ...
    [HttpGet("manage")]
    [HasPermission(ReportingPermissions.EditReportTemplates)]
    [ProducesResponseType(typeof(IReadOnlyList<ReportTemplateListItemResponse>), StatusCodes.Status200OK)]
    ...
    [HttpPost]
    [HasPermission(ReportingPermissions.CreateReportTemplates)]
