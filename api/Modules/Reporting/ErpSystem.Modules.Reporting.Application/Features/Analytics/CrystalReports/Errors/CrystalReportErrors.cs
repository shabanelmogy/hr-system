...
namespace ErpSystem.Modules.Reporting.Application.Features.Analytics.CrystalReports.Errors;
...
public sealed class CrystalReportErrors(IStringLocalizer<CrystalReportDetailResponse> localizer)
{
    ...
    public Error CrystalReportInspectorUnavailable => new("CrystalReport.InspectorUnavailable", localizer[nameof(CrystalReportInspectorUnavailable)], ErrorType.ServiceUnavailable);
    ...
    public Error CrystalReportDeploymentSourceChanged => new("CrystalReport.DeploymentSourceChanged", localizer[nameof(CrystalReportDeploymentSourceChanged)], ErrorType.Conflict);
    ...
    public Error CrystalReportDataTooLarge => new("CrystalReport.DataTooLarge", localizer[nameof(CrystalReportDataTooLarge)], ErrorType.PayloadTooLarge);
