...
namespace ErpSystem.Modules.Reporting.Application.Features.Analytics.CrystalReports.Contracts;
...
public sealed record CrystalReportRoleOptionResponse(string Id, string Name);
...
public enum CrystalReportDataFailure
{
    None = 0,
    Unsupported = 1,
    TooLarge = 2
...
public sealed record CrystalReportDataBuildResult(
    CrystalReportDataSet? Data,
    CrystalReportDataFailure Failure)
{
    public bool IsSuccess => Data is not null && Failure == CrystalReportDataFailure.None;
}
...
public sealed record DeploymentCrystalReportDescriptor(
    string SourceId,
    string EntityKey,
    string ReportKey,
    string FileName,
...
public enum CrystalReportDeploymentDownloadFailure
{
    None = 0,
    SourceChanged = 1,
    Unavailable = 2
...
public sealed record CrystalReportDeploymentDownloadResult(
    FileUpload? File,
    CrystalReportDeploymentDownloadFailure Failure)
{
    public bool IsSuccess => File is not null && Failure == CrystalReportDeploymentDownloadFailure.None;
}
