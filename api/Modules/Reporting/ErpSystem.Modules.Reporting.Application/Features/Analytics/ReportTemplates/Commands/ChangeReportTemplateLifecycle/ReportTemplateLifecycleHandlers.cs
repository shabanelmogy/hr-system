...
namespace ErpSystem.Modules.Reporting.Application.Features.Analytics.ReportTemplates.Commands.ChangeReportTemplateLifecycle;
    ...
    : ICommandHandler<ArchiveReportTemplateCommand, Result>
{
    public async Task<Result> Handle(ArchiveReportTemplateCommand request, CancellationToken cancellationToken)
    {
        ...
        template.DeletedByPc = currentActor.MachineName;
...
file static class LifecycleConcurrency
{
    public static void ApplyRowVersion(
        IReportTemplateStore store,
        ErpSystem.Modules.Reporting.Domain.Analytics.ReportTemplates.Entities.ReportTemplate template,
        string value)
    {
