...
/// <summary>
/// Creates only the Inventory context for EF design-time commands without
/// booting the API host or any other module.
/// </summary>
public sealed class InventoryDbContextDesignFactory
    : IDesignTimeDbContextFactory<InventoryDbContext>
{
    ...
    private static string ResolveConnectionString()
    {
        var environment = Environment.GetEnvironmentVariable("DOTNET_ENVIRONMENT")
            ...
            ?? "Development";
        // AddEnvironmentVariables below loads ConnectionStrings__Inventory
        ...
        foreach (var name in new[] { "Inventory", "DefaultConnection" })
        {
        ...
        throw new InvalidOperationException(
            "No effective connection string was configured. Set ConnectionStrings:Inventory "
            + "or ConnectionStrings:DefaultConnection before running Inventory EF design-time commands.");
    }
