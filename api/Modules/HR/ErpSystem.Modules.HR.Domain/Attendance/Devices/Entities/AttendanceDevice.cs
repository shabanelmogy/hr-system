namespace ErpSystem.Modules.HR.Domain.Attendance.Devices.Entities;
...
public sealed class AttendanceDevice : CompanyAuditableEntity
{
    ...
    public ErpSystem.Modules.HR.Domain.OrganizationalStructure.Entities.Branch? Branch { get; set; }
