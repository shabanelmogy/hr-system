using ErpSystem.Modules.HR.Application.Features.Analytics.CrystalReports.Commands;
using ErpSystem.Modules.HR.Application.Features.Analytics.CrystalReports.Contracts;
using ErpSystem.Modules.HR.Application.Features.Analytics.CrystalReports.Queries;
using ErpSystem.Modules.HR.Application.Common.Files;
using MediatR;

namespace ErpSystem.Modules.HR.Presentation.Features.Analytics.CrystalReports.V1;
