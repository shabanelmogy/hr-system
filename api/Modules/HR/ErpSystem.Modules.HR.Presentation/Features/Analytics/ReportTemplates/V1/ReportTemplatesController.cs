...
using ErpSystem.Modules.HR.Application.Features.Analytics.ReportTemplates.Commands.DuplicateReportTemplate;
using ErpSystem.Modules.HR.Application.Features.Analytics.ReportTemplates.Commands.UpdateReportTemplate;
using ErpSystem.Modules.HR.Application.Features.Analytics.ReportTemplates.Contracts;
using ErpSystem.Modules.HR.Application.Features.Analytics.ReportTemplates.Queries.GetReportDataSources;
using ErpSystem.Modules.HR.Application.Features.Analytics.ReportTemplates.Queries.GetReportTemplateById;
using ErpSystem.Modules.HR.Application.Features.Analytics.ReportTemplates.Queries.GetReportTemplateRevisions;
using ErpSystem.Modules.HR.Application.Features.Analytics.ReportTemplates.Queries.GetReportTemplates;
using MediatR;

namespace ErpSystem.Modules.HR.Presentation.Features.Analytics.ReportTemplates.V1;
