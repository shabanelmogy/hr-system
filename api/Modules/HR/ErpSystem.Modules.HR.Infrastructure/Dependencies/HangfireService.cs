...
using ErpSystem.Modules.HR.Infrastructure.Features.Platform.BackgroundJobs.Services;
...
public static class HangfireService
{
    public static IServiceCollection AddHangfireService(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddSingleton<IBackgroundJobDashboardSession, HangfireSessionAuthenticationService>();
