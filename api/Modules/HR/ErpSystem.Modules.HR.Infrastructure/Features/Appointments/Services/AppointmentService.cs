using ErpSystem.Modules.HR.Application.Features.Appointments.Services;
using ErpSystem.Modules.HR.Application.Features.Appointments.Contracts;
...
namespace ErpSystem.Modules.HR.Infrastructure.Features.Appointments.Services;
