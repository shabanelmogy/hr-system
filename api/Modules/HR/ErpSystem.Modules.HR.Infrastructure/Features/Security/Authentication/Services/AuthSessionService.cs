...
/// <summary>
/// Legacy ASP.NET Identity refresh-session implementation. Platform owns the
/// orchestration seam; this type retains physical hr Identity entity mutation.
/// </summary>
public sealed class AuthSessionService(
    ...
    AuthCompanyAccessService companyAccessAdministration,
    ...
    TimeProvider timeProvider)
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var replacedSessionId = httpContextAccessor.HttpContext?.User
            .FindFirstValue(AuthenticationTokenClaimNames.SessionId);
        ...
        CancellationToken cancellationToken)
    {
        ...
        var companyResponse = new CompanyOptionResponse(
            company.Id,
            company.CompanyCode,
            company.NameAr,
            company.NameEn);
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (!await companyAccessAdministration.IsUserWithinActorCompanyScopeAsync(
                user.Id,
                tenantId!,
                cancellationToken))
        {
