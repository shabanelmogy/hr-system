using ErpSystem.Modules.HR.Application.Features.Catalog.SubCategories.Abstractions;

namespace ErpSystem.Modules.HR.Infrastructure.Features.Catalog.SubCategories.Persistence;
