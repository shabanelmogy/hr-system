using ErpSystem.Modules.HR.Application.Features.Analytics.Reports.Abstractions;

namespace ErpSystem.Modules.HR.Infrastructure.Features.Analytics.Reports.Persistence;
