using ErpSystem.Modules.HR.Application.Features.Analytics.Reports.Services;
...
namespace ErpSystem.Modules.HR.Infrastructure.Features.Analytics.Reports.Services;
