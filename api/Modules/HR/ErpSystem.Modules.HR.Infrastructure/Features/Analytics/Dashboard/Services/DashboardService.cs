using ErpSystem.Modules.HR.Application.Features.Analytics.Dashboard.Services;
using ErpSystem.Modules.HR.Application.Features.Analytics.Dashboard.Contracts;

namespace ErpSystem.Modules.HR.Infrastructure.Features.Analytics.Dashboard.Services
{
