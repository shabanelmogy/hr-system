using ErpSystem.Modules.HR.Application.Features.Analytics.Exporting.Services;
using System.Data;
using ClosedXML.Excel;

namespace ErpSystem.Modules.HR.Infrastructure.Features.Analytics.Exporting.Services
{
