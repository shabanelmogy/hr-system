...
public interface IRecruitmentService
{
    ...
    // Job Requisitions
    Task<PageResponse<JobRequisitionDto>> GetJobRequisitionsPageAsync(int pageNumber, int pageSize, string? search, JobRequisitionStatusFilter? status, CancellationToken cancellationToken = default);
    ...
    // Job Openings
    Task<PageResponse<JobOpeningDto>> GetJobOpeningsPageAsync(int pageNumber, int pageSize, string? search, JobOpeningStatusFilter? status, int? departmentId, CancellationToken cancellationToken = default);
    ...
    // Job Postings
    Task<PageResponse<JobPostingDto>> GetJobPostingsPageAsync(int pageNumber, int pageSize, string? search, JobPostingStatusFilter? status, CancellationToken cancellationToken = default);
    ...
    Task<PageResponse<EmploymentApplicationDto>> GetApplicationsPageAsync(int pageNumber, int pageSize, string? search, int? jobOpeningId, ApplicationStatusFilter? status, CancellationToken cancellationToken = default);
    ...
    Task<Result<EmploymentApplicationDto>> MoveApplicationStageAsync(int id, ApplicationStatusFilter targetStatus, string? reason, CancellationToken cancellationToken = default);
    ...
    // Interviews
    Task<PageResponse<InterviewDto>> GetInterviewsPageAsync(int pageNumber, int pageSize, int? applicationId, InterviewStatusFilter? status, CancellationToken cancellationToken = default);
    ...
    // Job Offers
    Task<PageResponse<JobOfferDto>> GetJobOffersPageAsync(int pageNumber, int pageSize, int? applicationId, JobOfferStatusFilter? status, CancellationToken cancellationToken = default);
