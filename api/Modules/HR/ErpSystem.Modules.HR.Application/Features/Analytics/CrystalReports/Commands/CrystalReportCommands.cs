...
using ErpSystem.Modules.HR.Application.Features.Analytics.CrystalReports.Validation;

namespace ErpSystem.Modules.HR.Application.Features.Analytics.CrystalReports.Commands;
