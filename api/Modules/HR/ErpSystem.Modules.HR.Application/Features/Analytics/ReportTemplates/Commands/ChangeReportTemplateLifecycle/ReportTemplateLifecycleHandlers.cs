...
namespace ErpSystem.Modules.HR.Application.Features.Analytics.ReportTemplates.Commands.ChangeReportTemplateLifecycle;
...
file static class LifecycleConcurrency
{
    public static void ApplyRowVersion(
        IReportTemplateStore store,
        ErpSystem.Modules.HR.Domain.Analytics.ReportTemplates.Entities.ReportTemplate template,
        string value)
    {
