namespace ErpSystem.Modules.HR.Application.Features.OrganizationalStructure.Management;
...
public static class OrganizationalResources
{
    ...
    [
        Branches, Departments, Divisions, JobTitles, JobLevels, Positions, JobDescriptions, CostCenters
    ];
