...
{
    public static string Type { get; } = PermissionClaimNames.Permission;
    ...
    public const string ManageOfflineOperations = OfflineOperationsPermissions.Manage;
    ...
    public static IReadOnlyList<string> GetPlatformGeographyPermissions() =>
        PlatformPermissions.GetAll();

    public static IReadOnlyList<string> GetTenantPermissions() =>
        GetAllPermissions()
            .Where(permission => !PlatformPermissions.IsPlatformPermission(permission))
            .ToList();
