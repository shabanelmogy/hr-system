    ...
    IMapper mapper) : ICountryService
{
    ...
    public async Task<Result> AddRangeAsync(List<CountryRequest> countryRequests, CancellationToken cancellationToken = default)
    {
        ...
        await PublishCountryUpdateAsync(null, "BulkAdd", cancellationToken);
    ...
    private async Task PublishCountryUpdateAsync(CountryResponse? country, string action, CancellationToken cancellationToken)
    {
