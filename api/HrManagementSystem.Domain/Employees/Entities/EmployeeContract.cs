...
public class EmployeeContract : CompanyAuditableEntity
{
    ...
    /// <summary>Creates a contract that is attached to a new employee before
    /// the identity key is generated by the same SaveChanges operation.</summary>
    public static EmployeeContract ForPendingEmployee(
        string contractNumber,
        EmployeeContractType contractType,
        DateOnly startDate,
        DateOnly? endDate)
