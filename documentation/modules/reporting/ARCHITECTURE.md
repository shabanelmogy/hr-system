...
The module is a bounded context composed through `ErpSystem.Modules.Reporting.ReportingModule`.
...
- Schema: `rpt` (one module-owned schema and migrations history table).
