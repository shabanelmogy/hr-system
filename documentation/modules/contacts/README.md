...
This package is the documentation ownership boundary for the **Contacts** module.
...
- Runtime foundation: six projects, a module bootstrap, and an EF Core context
  using the `contacts` schema.
- First verified feature: tenant/company-scoped Party create/update/read with
  transactional integration events and an Accounting-local reference projection.
- No client screen is implied by this backend reference slice.
