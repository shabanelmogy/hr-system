...
| --- | --- | --- | --- |
| E-01 | Countries are global | `api/Modules/ReferenceData/ErpSystem.Modules.ReferenceData.Domain/GeographicalInformation/Countries/Entities/Country.cs` | Entity has no scope marker |
