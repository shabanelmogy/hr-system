...
work is `Clean_Architecture_CQRS_Guide.md`; the general API-to-web workflow is
`../project/CORE_FEATURE_CQRS_WEB_GUIDE.md`. The exact Countries package across
API, web and mobile is `../project/COUNTRIES_FEATURE_FULL_REVIEW.md`.
