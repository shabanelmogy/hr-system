...
- Align strictly with backend user stories and endpoints from `documentation/api/User Stories/KanbanBoard`.
...
- Refer to backend docs under `documentation/api/User Stories/KanbanBoard` for request/response examples and rules. Ensure your TypeScript types align with these contracts.
